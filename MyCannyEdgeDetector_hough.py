...
def myCannyEdgeDetector(img, sigma, low, high, line_width=1):
    ...
    if len(img.shape) == 3:
        ...
        if img.max() > 1:
            img = img / 255
    kernel, d_kernel = get_gaussian_kernel(sigma=sigma)
    ...
    return my_edge, img_x, img_y, gradient_mag
...
if __name__ == '__main__':
    ...
    my_edge, img_x, img_y, gradient_mag = myCannyEdgeDetector(image, 0.1, 0.2)
